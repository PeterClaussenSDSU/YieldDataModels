...
Years <- c(2013:2018,2020)

Crops <- c('Corn','Soybeans','Corn','Soybeans','Corn','Soybeans','Corn','Corn')
...
#  Rprof(NULL)
  ...
  Methods[[j]] <- list(Models=Models,
                       ...
                       BestBIC=BestBICC,
                       BestSlope=BestSlopeC,
                       BestNugget=BestNuggetC)
}
